...
class ScriptArguments:
    model_name_or_path: Optional[str] = field(
        default="",
        metadata={"help": "the location of the trained model name or path"},
    )
    ...
    dataset_key1: Optional[str] = field(
        default="",
        metadata={"help": "the key1 of the dataset"},
    )
...
for i, output in enumerate(outputs):
    tmp_data = {"prompt": ds[i][script_args.dataset_key], "responses": ds[i][script_args.dataset_key1], "generated": [out.text for out in output.outputs]}
